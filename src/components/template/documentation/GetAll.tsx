...
import { getAllBlogs,allData } from '@/utils/endpoints'
...
function GetAll() {
  ...
  < p className='mt-8 text-lg md:text-xl'>
   Fetch the endpoint provided below to retrieve all the blogs, and also test it here.
  ...
  <div className="min-w-full py-4">
      <Snippets text="Get All Blogs" code={getAllBlogs} />
{
  writeData ? 
...
{
    writeData ?
    <Snippets text="Single Article" code={allData} />
    : ""
}
