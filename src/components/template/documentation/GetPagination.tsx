...
import { paginationBlog,paginationData } from '@/utils/endpoints'
...
function GetPagination() {
  ...
  <h1 className='text-xl md:text-4xl font-bold mt-9'>
    How to get blogs with Pagination
  </h1>
  < p className='mt-8 text-lg md:text-xl'>
   Fetch the endpoint provided below to retrieve blogs with pagination,By default the limit of blog per page is 8 you can increase or decrease it and also test it here.
  ...
  <div className="min-w-full py-4">
      <Snippets text="Pagination" code={paginationBlog} />
{
  writeData ? 
...
{
    writeData ?
    <Snippets text="Pagination Article" code={paginationData} />
    : ""
}
