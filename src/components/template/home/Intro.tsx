...
function Intro() {
  ...
  return (
    <>
      <div className="min-h-[36rem] w-full overflow-x-hidden dark:bg-black bg-white flex-col  dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.2] relative flex items-center">
